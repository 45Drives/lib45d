...
std::string every_char_except_hash_and_ws = "!\"$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
std::string every_char_except_hash_and_ws_and_equals = "!\"$%&'()*+,-./0123456789:;<>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
...
void test_strip_whitespace() {
    ...
    test_string = " \t \t" + every_char_except_hash_and_ws + " \t \t" + every_char_except_hash_and_ws + " \t \t";
...
void test_remove_comments() {
    ...
    std::string test_string = every_char_except_hash_and_ws + "# \t" + every_char_except_hash_and_ws + "# \t" + every_char_except_hash_and_ws;
...
void test_check_record_type() {
    ...
    std::cout << "asserting \"" + every_char_except_hash_and_ws + "\" is l::RecordType::ENTRY" << std::endl;
    ...
    std::cout << "asserting \" \\t[ \\t# \\t" + every_char_except_hash_and_ws + " \\t] \\t\" is l::RecordType::HEADING" << std::endl;
    assert(l::check_record_type(" \t[ \t# \t" + every_char_except_hash_and_ws + " \t] \t") == l::RecordType::HEADING);
    std::cout << "OK" << std::endl;

    std::cout << "asserting \"" + every_char_except_hash_and_ws_and_equals + "\" is l::RecordType::UNK" << std::endl;
